...
export const threatStats = [
  {
    label: 'Filipinos lost to scams in 2025',
    value: 'N/A',
    color: 'text-red-400',
    sublabel: 'Total financial damage reported (BSP, CICC)',
  },
  {
    label: 'Online scam cases filed',
    value: 'N/A',
    color: 'text-yellow-400',
    sublabel: 'Reported to PNP-ACG & CICC',
  },
  {
    label: 'Rise in phishing attempts',
    value: 'N/A',
    color: 'text-red-400',
    sublabel: 'Year-over-year increase (Kaspersky PH)',
  },
  {
    label: 'Most targeted age group',
    value: 'N/A',
    color: 'text-yellow-400',
    sublabel: 'Highest victim demographic (DICT)',
  },
];
...
export const scamTypes: ScamType[] = [
  {
    ...
    description:
      'Scammers impersonate trusted institutions, government agencies, or people you know — via email, SMS, calls, or DMs — to steal your credentials, OTP, or personal information.',
    tabs: [
      {
        label: 'Via Email',
        content: {
      ...
      },
      {
        ...
        content: {
          ...
          extra: {
            moneyRequest:
              "Baby, my tools were held at customs. I need \u20b135,000 to release them \u2014 I'll pay you back double. You're the only person I trust.",
          },
        },
      },
    ],
  },
  {
    ...
    description:
      'Scammers lure victims with impossible promises — lottery winnings, exclusive deals, investment returns — to extract upfront fees, personal info, or payment.',
    tabs: [
      {
        label: 'Via Email',
        content: {
      ...
      },
      {
        ...
        content: {
          ...
          callout:
            'A price that seems impossible IS impossible. Sellers who refuse COD and require full GCash payment upfront will disappear with your money.',
        },
      },
      {
        ...
        content: {
          ...
          callout:
            'NEVER transact outside the official Shopee/Lazada platform. Moving payment off-platform removes all buyer protection.',
        },
      },
      {
        ...
        content: {
          ...
          annotations: [
            'Stranger promising investment returns',
            '500% returns in one month',
            "'Private platform' = pig butchering setup",
          ],
          callout:
            "This is the 'pig butchering' scam. Scammers fatten the victim with fake returns before taking everything.",
        },
      },
    ],
  },
    ...
    tabs: [
        ...
        content: {
          ...
          extra: {
            urls: [
              ...
              {
                label: 'Typosquatted',
                url: 'https://www.bd0.com.ph',
                verdict: 'danger',
                highlight: '0 instead of O',
              },
              {
                label: 'Subdomain trick',
                url: 'https://bdo.com.ph.login-secure.xyz',
                verdict: 'danger',
                highlight: 'Real domain is .xyz',
              },
              {
                label: 'Homoglyph',
                url: 'https://www.bd\u043e.com.ph',
                verdict: 'danger',
                highlight: 'Cyrillic \u043e character',
              },
            ],
          },
        },
      },
      {
        ...
        content: {
          ...
          callout:
            'QR codes can silently redirect you to phishing sites. Always verify the URL the QR points to BEFORE entering any credentials.',
      ...
      },
      {
        ...
        content: {
          ...
          annotations: [],
          callout:
            'SIM Swap is silent \u2014 you may not realize it happened until your accounts are drained. Act within minutes of losing signal unexpectedly.',
          extra: {
            steps: [
      ...
      },
      {
        ...
        content: {
          ...
          annotations: [
            'This tracking number may not exist \u2014 or may be reused from an old shipment',
          ],
          callout:
            'Forged shipping receipts are the #1 fake seller trick. Always go to lbcexpress.com yourself and manually type the tracking number to verify.',
      ...
      },
      {
        ...
        content: {
          ...
          annotations: [
            ...
            'Official fundraising uses trusted platforms',
            'High share count can be manufactured',
          ],
          callout:
            'Fake charity scams spike after every natural disaster. Before donating, verify the organization through SEC Philippines or DSWD.',
...
export const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'hero.subtitle':
      'Cyber threats are evolving rapidly. P.R.O.O.F. is here to help you stay one step ahead \u2014 learn to identify, avoid, and report online scams.',
    ...
    'about.body':
      'P.R.O.O.F is a proactive awareness campaign designed to educate and protect the community from malicious digital threats. Our mission is to ensure everyone\u2014especially vulnerable populations\u2014can navigate the digital landscape securely.',
  ...
  fil: {
    ...
    'about.body':
      'Kami ay isang dedikadong kolektibo ng mga tagapagtaguyod na nagtatrabaho nang magkasama upang magdala ng makabuluhang pagbabago.',
  ...
  ceb: {
    ...
    'about.title2': 'KAMPANYA',
    'about.body':
      'Kami usa ka dedikado nga kolektibo sa mga tigpaluyo nga nagtinabangay aron magdala ug kausaban.',
